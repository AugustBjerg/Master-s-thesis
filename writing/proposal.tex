...
Paragraph 1: Reason for choosing a case study approach
- It is proposed to take a case-study approach for two reasons
   1. The shipping industry has yet to agree on a global standard for data formats and collection practices, making cross-vessel analysis difficult and subject to unobservable biases \parencite{ISO19030-2-2016}
   2. Most vessels are not equipped with the necessary sensors to collect the data required for this type of analysis, meaning that obtaining a quality cross-vessel dataset is somewhat unrealistic \parencite{Kim2023ShipEnergyEfficiencyData}

   A dataset containing time-series data from a bulk carrier in operation has been obtained
- Stems from the “Real Vessel Data Challenge” – workshop, hosted by the Mærsk McKinney-Møller Center for Zero Carbon Shipping\footnote{Since this is the project I will do for my master's thesis, I can confirm that i have received this data and started working on it. However, the data and workshop specifications are not be accesible to the public} \parencite{TsarsitalidisPonkratovTsoulakos2025RealVesselDataChallenge}.  
- 

- Quick high-level rundown of a couple relevant ship particulars
