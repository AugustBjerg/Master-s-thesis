...
def save_pipeline(pipeline: Pipeline, output_dir: str, incl_fouling: bool) -> str:
	...
	if incl_fouling:
		save_path = os.path.join(output_dir, f"random_forest_pipeline_incl_fouling_{WINDOW_LENGTH}.joblib")
	elif not incl_fouling:
		save_path = os.path.join(output_dir, f"random_forest_pipeline_excl_fouling_{WINDOW_LENGTH}.joblib")
