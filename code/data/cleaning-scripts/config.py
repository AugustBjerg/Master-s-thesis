...
DRAFT_CONTROLLED_VARIABLE_RANGE = [6.1, 11.615, 14.2]

# Loading conditions from ship particulars.
LOADING_CONDITION_SCENARIOS = {
    "Ballast": {
        DRAFT_CONTROLLED_VARIABLE_NAME: 6.1,
        DRAFT_TRIM_CONTROLLED_VARIABLE_NAME: 2.6,
    },
    "Design": {
        DRAFT_CONTROLLED_VARIABLE_NAME: 11.615,
        DRAFT_TRIM_CONTROLLED_VARIABLE_NAME: 0.81,
    },
    "Scantling": {
        DRAFT_CONTROLLED_VARIABLE_NAME: 14.2,
        DRAFT_TRIM_CONTROLLED_VARIABLE_NAME: 1.0,
    },
}
